...
function goFindId() {
    document.defaultForm.action="<c:url value='/cmm/init/searchIdPassword.do'/>";
...
function goRegiUsr() {
    ...
    // 일반회원
    if (userSe == "GNR") {
        document.loginForm.action="<c:url value='/cmm/init/EgovStplatCnfirmMber.do'/>";
        document.loginForm.submit();
    // 기업회원
    } else if (userSe == "ENT") {
        document.loginForm.action="<c:url value='/cmm/init/EgovStplatCnfirmEntrprs.do'/>";
        document.loginForm.submit();
    // 업무사용자
    } else if (userSe == "USR") {
...
<div class="login_form">
	<form name="loginForm" id="loginForm" action="<c:url value='/cmm/init/actionLogin.do'/>" method="post">
