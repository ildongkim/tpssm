...
function fnListPage(){
    document.entrprsManageVO.action = "<c:url value='/cmm/init/EgovEntrprsMberManage.do'/>";
...
<!-- content start -->
 <form:form commandName="entrprsManageVO" action="${pageContext.request.contextPath}/cmm/init/EgovEntrprsMberSbscrb.do" name="entrprsManageVO" method="post" onSubmit="fnInsert(document.forms[0]); return false;"> 
